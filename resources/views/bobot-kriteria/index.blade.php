...
@section('content')
                ...
                <div
                    ...
                    <div class="px-6 pt-4">
                        <div class="flex gap-2 border-b border-gray-200 dark:border-slate-700">
                            <button
                                class="tab-btn px-4 py-2 text-sm font-medium text-gray-500 border-b-2 border-transparent"
                                data-tipe="hotel">
                                Hotel
                            </button>
                            ...
                            <table id="kriteriaTable"
                                ...
                                <thead class="align-bottom bg-gray-100 dark:bg-slate-700 text-slate-700 dark:text-white">
                                    <tr>
                                        ...
                                        <th class="px-4 py-3 font-semibold text-left">Nama Kriteria</th>
                                        <th class="px-4 py-3 font-semibold text-center">Jenis</th>
                                        <th class="px-4 py-3 font-semibold text-center">Bobot</th>
    ...
    @include('bobot-kriteria.ModalForm')

    @push('scripts')
        <script src="{{ asset('assets/js/backend/kriteria.js') }}"></script>
    @endpush
@endsection
